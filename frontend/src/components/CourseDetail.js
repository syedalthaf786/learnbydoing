    ...
    curriculum: [
      {
        ...
        lessons: ['Web Development Overview', 'Setting Up Your Environment']
      },
      {
        title: 'HTML Fundamentals',
        lessons: ['HTML Structure', 'Semantic Elements', 'Forms and Validation']
      },
      {
        title: 'CSS Styling',
        lessons: ['CSS Selectors', 'Box Model', 'Flexbox and Grid']
      },
      {
